<html>
	...
	<head>
		...
		<title>Listado de ${model.nombre}</title>
			...
			<div class="col card hoverable s12 m8 pull-m2 l6 pull-l3">
				...
				<form id="form_main">
					...
					<div class="card-content">
		        		...
		        		<span class="card-title" id="card_title">Listado de ${model.nombre}</span>
								...
								<li>
									...
									<div class="collapsible-body no-margin row col s12">
										...
										<div class="input-field no-margin col s12 m6">
											...
											<label class="no-margin" for="filter">Nombre</label>
										</div>
	...
	<script type='text/javascript'>
		...
		for (i = 0; i < data.length; i++) {
			...
			array[i] = new Object();
			array[i] = '<a href="${model.linkName}/' + data[i].id + '.html">' + data[i].nombre + '</a>';
