...
import rio.antelodel.david.ejercicios_programacion.rich_entity.filter.implementation.FilterIRCategoria;
...
public class FilterRCategoriaTest extends ATest {
	...
	private FilterIRCategoria filterIRCategoria;
	...
	public void before () {
		...
		filterIRCategoria = new FilterIRCategoria();
		
		when(iRCategoria1.getId()).thenReturn(0);
		when(iRCategoria2.getId()).thenReturn(1);
		when(iRCategoria3.getId()).thenReturn(2);
	...
	public void testMatches_True () {
		...
		assertTrue(filterIRCategoria.matches(iRCategoria1, filter1));
	...
	public void testMatches_False () {
		...
		assertFalse(filterIRCategoria.matches(iRCategoria1, filter2));
	...
	public void testMatchesObject_FilterIsAny () {
		...
		FilterIRCategoria filterIRCategoriaSpy = spy(filterIRCategoria);
