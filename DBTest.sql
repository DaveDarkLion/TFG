DROP DATABASE IF EXISTS gestion_ejercicios_programacion_test;
CREATE DATABASE gestion_ejercicios_programacion_test;
USE gestion_ejercicios_programacion_test;
